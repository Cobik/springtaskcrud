...
<head>
    ...
    <link href="${pageContext.request.contextPath}/resources/css/buttonstyle.css" rel="stylesheet" type="text/css">
...
<table class="wrap-table100">
    ...
    <c:forEach items="${usersFromServer}" var="user">
        <tr>
            ...
            <td class="column5">
                <a href="${pageContext.request.contextPath}/edit?id=${user.id} " methods="get"
                   class="button">Edit</a>
            </td>
            <td class="column6">
                <a href="${pageContext.request.contextPath}/delete?id=${user.id}" class="buttonRed">Delete</a>
            </td>
        </tr>
    </c:forEach>
</table>

<a href="/addUser" class="button">Add</a>
